...
app.use(cors({ origin: 'https://apex-home-stores.vercel.app/' }));
      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; color: #1a1a1a;">
          <div style="background-color: #8b7355; padding: 24px; text-align: center;">
            <h1 style="color: white; margin: 0; font-size: 1.4rem;">Apex Home Furnishings</h1>
          </div>
          <div style="padding: 32px; background: #f9f6f2;">
            <h2 style="margin: 0 0 16px;">Welcome, ${name}! 🎉</h2>
            <p style="color: #5a5550; line-height: 1.7;">
              Your account has been created successfully. You can now shop our full
              collection of premium handcrafted furniture, track your orders, and
            ...
            <p style="margin-top: 28px; font-size: 0.85rem; color: #9a9088;">
              Use code <strong>EASTER30</strong> at checkout for 30% off your first order.
            </p>
          </div>
          <div style="padding: 16px; text-align: center; background: #1a1412;">
            <p style="color: #6b6460; font-size: 0.75rem; margin: 0;">
